...
#### X.Model structure
The image of the model prepared in "[Hand_Gestures.ipynb](Hand_Gestures.ipynb)" is as follows.
...
#### X.Model structure
The image of the model prepared in "[Finger_Gestures.ipynb](Finger_Gestures.ipynb)" is as follows.
